[![Build status](https://ci.appveyor.com/api/projects/status/x91w60ic3j5v5k00?svg=true)](https://ci.appveyor.com/project/ajoq/ahj-homeworks-9-anim)

GH pages: https://ajoq.github.io/ahj-homeworks_9-anim/
...
### Комментарий к задаче Collapse (реализация)

Каждому элементу, при клике на который будет показан скрытый элемент, необходимо задать data-атрибуты:

* data-toggle="collapse" - на элемент будет назначен обработчик события по клику
* data-target="вашID" - элемент с id="вашID" будет показан по клику

Элементу, который будет показан, необходимо назначить id="вашID". Несколько кнопок могут показывать / скрывать один элемент
